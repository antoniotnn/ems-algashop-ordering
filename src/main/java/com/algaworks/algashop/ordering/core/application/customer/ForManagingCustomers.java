...
public class ForManagingCustomers implements com.algaworks.algashop.ordering.core.ports.in.customer.ForManagingCustomers {
    ...
    public UUID create(CustomerInput input) {
        ...
        Customer register = customerRegistration.register(
